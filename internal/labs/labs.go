...
func NewLabHandler(labName string, graderFilename string, graderFile []byte, makeFilename string, makeFile []byte) error {
...
func EditLab(labName string, graderFilename string, graderFile []byte, makeFilename string, makeFile []byte) error {
	...
	err = NewLabHandler(labName, graderFilename, graderFile, makeFilename, makeFile)
	if err != nil {
