...
func NewHostSSHClient(machine MachineOptions) (*DkClient, error) {
...
func NewSSHClientWithPublicKeyAuth(machine MachineOptions) (*DkClient, error) {
...
func NewSSHClientWithPasswordAuth(machine MachineOptions) (*DkClient, error) {
...
func createSshDockerConnection(machine MachineOptions, auth ...ssh.AuthMethod) (*DkClient, error) {
...
func getClientList() map[string]MachineOptions {
	var machineMap = map[string]MachineOptions{}

	// Get all settings
	allSettings := config.ClientsSSH.GetAny()
